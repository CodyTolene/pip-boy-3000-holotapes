...
(function () {
  ...
  const MAPS_DIR = 'HOLO/RADROACH_RACES/MAPS.JS';
  const SFX = {
  ...
  const MAP_DATA = eval(fs.readFileSync(MAPS_DIR));
  ...
  function startCountdown() {
    ...
    const horizSpawn =
      currentMapId === 1 || currentMapId === 5 || currentMapId === 7;
    ...
    radroaches = [
      {
        id: 1,
        cx: startX + 7 + (horizSpawn ? slots[0] : 0),
        cy: startYBase + 7 + (horizSpawn ? 0 : slots[0]),
        vx: 0,
        vy: 0,
      },
      {
        id: 2,
        cx: startX + 7 + (horizSpawn ? slots[1] : 0),
        cy: startYBase + 7 + (horizSpawn ? 0 : slots[1]),
        vx: 0,
        vy: 0,
      },
      {
        id: 3,
        cx: startX + 7 + (horizSpawn ? slots[2] : 0),
        cy: startYBase + 7 + (horizSpawn ? 0 : slots[2]),
        vx: 0,
        vy: 0,
      },
      {
        id: 4,
        cx: startX + 7 + (horizSpawn ? slots[3] : 0),
        cy: startYBase + 7 + (horizSpawn ? 0 : slots[3]),
        vx: 0,
        vy: 0,
      },
      {
        id: 5,
        cx: startX + 7 + (horizSpawn ? slots[4] : 0),
        cy: startYBase + 7 + (horizSpawn ? 0 : slots[4]),
        vx: 0,
        vy: 0,
      },
    ];
  ...
  function displayWinner() {
    ...
    h.setFont('Monofonto16')
      .setFontAlign(0, -1)
      .setColor(3)
      .drawString('"' + ROACH_LETTERS[winnerId] + '" ROACH WINS!!!', 240, 140)
      .setFont('Monofonto14')
