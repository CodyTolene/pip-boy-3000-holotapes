...
A single-player poker game against a dealer CPU. 5 and 7 card draw game modes with a betting system in place.

### Controls

| Input                                 | Action                                        |
| ------------------------------------- | --------------------------------------------- |
| Left scroll wheel (knob1) up/down     | Adjust bet amount (10-chip increments) and    |
                                          scroll along dealt hand to select discards    |
